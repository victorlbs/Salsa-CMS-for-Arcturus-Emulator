...
<head>
    ...
    <title>
        <?php echo nome ?>: Colaboradores</title>
</head>
...
<?php } ?>
                ...
                <div class="col-sm-4">
                    <div id="redondo-cmc" class="card">
                        <div id="redondo" class="p-3 mb-2 bg-dark text-white">Um pouco sobre a colaboradores
                        </div>
                        <div class="card-body">
                           Colaboradores são um conjunto de jogadores que tornam sua experiência no jogo melhor, eles que te darão todo o suporte que você precisar. <br>
